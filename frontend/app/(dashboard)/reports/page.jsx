...
import { FileText, Sparkles, Download, Copy, Printer, Check } from "lucide-react";
...
function ReportGenerator() {
  ...
  const handleCopy = () => {
    ...
    tempDiv.innerHTML = generatedReport.report;
    const cleanText = tempDiv.textContent || tempDiv.innerText || generatedReport.report;
            ...
            <div className="panel p-0 overflow-hidden bg-white shadow-sm print:shadow-none print:border-none">
              <div className="bg-gray-50 border-b p-4 flex items-center justify-between print:hidden">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button 
                    onClick={handleCopy} 
                    className="flex items-center gap-1.5 px-2.5 py-1.5 text-gray-600 hover:text-gray-900 hover:bg-gray-200 rounded-lg text-xs transition-colors border bg-white"
                  ...
                  <button 
                    ...
                    className="p-1.5 text-gray-600 hover:text-gray-900 hover:bg-gray-200 rounded-lg transition-colors border bg-white"
                    title="Print Report"
                  >
                    <Printer size={16} />
                  </button>
