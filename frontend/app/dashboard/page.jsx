...
function DatasetDashboard() {
  ...
  return <div className="page-shell">
    ...
    <section className="mt-8"><div className="mb-4"><h2 className="section-heading">Source preview</h2><p className="mt-1 text-sm muted">First {Math.min(preview.length, 50)} rows · first {previewColumns.length} columns</p></div><DataTable columns={previewColumns} rows={preview} /></section>
  </div>;
}
